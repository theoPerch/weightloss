...
class PerchListings_Runtime
{
	...
	{
		if (!isset(self::$instance)) self::$instance = new PerchListings_Runtime;
        return self::$instance;
	}

	public function __construct()
	{
		$this->api = new PerchAPI(1.0, 'perch_listings');
