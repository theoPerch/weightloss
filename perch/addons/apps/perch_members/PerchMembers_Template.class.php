...
class PerchMembers_Template extends PerchAPI_TemplateHandler
{
	...
	protected function parse_conditional($type="member", $opening_tag="", $condition_contents="", $exact_match="", $template_contents="", $content_vars="", $index_in_group=false)
	{
    ...
    private function parse_paired_tags($type='member', $empty_opener=false, $contents="", $content_vars="", $index_in_group=false, $callback='parse_conditional')
    {
