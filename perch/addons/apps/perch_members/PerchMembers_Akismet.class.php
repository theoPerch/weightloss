...
class PerchMembers_Akismet
{
  ...
  $data['first_name']       = (isset($fields['first_name'])  ? $fields['first_name']  : '');
        $data['memberEmail'] = (isset($fields['memberEmail']) ? $fields['memberEmail'] : '');
        $data['last_name']   = (isset($fields['last_name'])   ? $fields['last_name']   : '');
        $data['password']      = (isset($fields['password'])  ? $fields['password']  : '');
  ...
  $data['first_name']       = (isset($fields['first_name'])  ? $fields['first_name']  : '');
    ...
    private static function make_request($type, $data)
    {
        ...
        $path = '/1.1/'.$type;
        $port = 80;
        $akismet_ua = "Perch/".$Perch->version." | perch_members";
