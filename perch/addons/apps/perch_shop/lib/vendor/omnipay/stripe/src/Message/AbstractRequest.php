 ...
 */
// perch/addons/apps/perch_shop/lib/vendor/omnipay/common/src/Common/Message/AbstractRequest.php
abstract class AbstractRequest  extends \Omnipay\Common\Message\AbstractRequest
{
    ...
    public function sendData($data)
    {
      ...
      /*  $headers = array_merge(
            $this->getHeaders(),
            array('Authorization' => ' Bearer ' . $this->getApiKey(),'Content-Type' => 'application/x-www-form-urlencoded')
        );*/

      $headers = array_merge(
          $this->getHeaders(),
         array('Content-Type' => 'application/x-www-form-urlencoded','Authorization' => ' Bearer ' . $this->getApiKey())
     );


       $client = new GuzzleHttp\Client(['headers' => $headers]);
      $body = $data ? http_build_query($data, '', '&') : null;
        $httpResponse = $client->request($this->getHttpMethod(), $this->getEndpoint(), ['body'=>$body]);


         // echo "httpResponsehttpResponse";
