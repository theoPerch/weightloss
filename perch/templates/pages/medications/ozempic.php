           ...
           <div class="mounjaro_content" style="color: #fff;" >
            <div class="row align-items-center">
                ...
                <div class="col-md-6 title ">
                  <div class="works">
                    <h6 class="text-uppercase" style=" color: #fff; font-weight: 500;" >Type 2 Diabetes</h6>
                  <h2 class="fw-bold" style="text-transform: uppercase;" ><span style="font-size: 62px;" >Ozempic®: A Proven Treatment for Type 2 Diabetes</span> </h2>
                  <p class="expert" >Stimulating insulin secretion</p>
                  <p class="expert" >Reducing glucagon production </p>
                    <p class="expert" >Slowing gastric emptying</p>
            
                  </div>
                      <div class="min_img2 min_img3 " style="background-color: #94ACB3;" >
                          <img src="/asset/1234.webp" alt="Happy Woman" class="img-fluid rounded">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="effective_content">
              <p>Ozempic® (semaglutide) is a once-weekly injectable medication designed to help adults with type 2 diabetes manage their blood sugar levels. As a GLP-1 receptor agonist, it works by stimulating insulin secretion; reducing glucagon production and slowing gastric emptying.
              </p>
              <p>All this helps to manage blood sugar levels. This combination of effects also supports weight loss, making it a valuable tool for those aiming to reduce body weight and improve metabolic health.
</p>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-6 research_image ">
                        ...
                        <div class="research_img" style="height: auto;" >
                            <img  src="/asset/clinically-12.webp" class="img-fluid" alt="Research Report">
                        </div>
...
<!--
                    ...
                    <p class="text-muted">When using Ozempic, you are injecting a medication called semaglutide.Here's what it involves: </p>
<p><b>Semaglutide: </b>The active ingredient in Ozempic, a GLP-1 receptor agonist. </p>
                   <p><b>Subcutaneous Injection: </b>Administered once a week via a small needle under the skin.
                   </p>
                    <p><b>Easy to Use: </b>Comes with a pre-filled pen for convenient, self-administration.
                   </p>
...
<!--
                    ...
                    <p class="text-muted">
Ozempic may cause some side effects, though they aren't experienced by everyone. Potential side effects include:</p>
 <p><b>Nausea and Vomiting: </b>Common, especially when starting treatment.</p>
  <p><b>Digestive Issues:</b> Diarrhea, constipation, or stomach pain.</p>
  <p><b>Headache and Fatigue: </b>May occur during initial use.</p>
 <p><b>Risk of Low Blood Sugar:</b> When combined with other diabetes medications.</p>
            ...
            <div class="col-md-6 research_image ">
                ...
                <div class="research_img" style="height: auto;" >
                    <img src="/asset/clinically-13.webp" class="img-fluid" alt="Research Report">
                </div>
 ...
 <section class="KNOWLEDGe">
  <div class="containrt">
      <div class="knowledge_text">
          <div class="effective_shortTitle">
              <span style="color: #fff;" >Health Hub & News</span>
          </div>
          <div class="effective_longTitle">
