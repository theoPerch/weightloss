...
if (version_compare(PHP_VERSION, '5.3.0', '<')) {
   ...
   /* if (!defined('PERCH_DATE_LONG'))        define('PERCH_DATE_LONG', '%d %B %Y');
    ...
    if (!defined('PERCH_DATE_LONG'))        define('PERCH_DATE_LONG', 'd M Y');
    if (!defined('PERCH_DATE_SHORT'))       define('PERCH_DATE_SHORT', 'd M Y');
    if (!defined('PERCH_TIME_SHORT'))       define('PERCH_TIME_SHORT', 'H:i');
    if (!defined('PERCH_TIME_LONG'))        define('PERCH_TIME_LONG', 'H:i:s');
