...
$Perch->page_title = PerchLang::get('Collection Indexes');
...
include(PERCH_CORE.'/runway/apps/content/modes/collection.indexes.edit.pre.php');
include($app_path.'/modes/_subnav.php');
include(PERCH_CORE . '/inc/top.php');

include(PERCH_CORE.'/runway/apps/content/modes/collection.indexes.edit.post.php');
