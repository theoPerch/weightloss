...
function toMoney($val=0,$symbol='$',$r=2)
{
    ...
    $length = strlen((string)$i);  // Convert number to string and get its length
    ...
    protected function _format($tag, $modified_value)
    {
    	switch (substr($tag->format(), 0, 2)) {
            ...
            case '$:':
               ...
               $modified_value = $this->toMoney(floatval($modified_value));
            ...
            default:
                if (strpos($tag->format(), '%')===false) {
                	...
                	/* if (defined('PERCH_LOCALE')) {
                             $modified_value = IntlDateFormatter::formatObject(
                                                    new DateTime(($modified_value)), //a DateTime object
                                                   "eeee dd MMMM yyyy '@' hh:mm:ss",  //UCI standard formatted string
                                                   PERCH_LOCALE //the locale
                                               );
		           ...
		           $modified_value = date($tag->format(), strtotime($modified_value));
		        	...
		        	//echo "tag format 2";echo $tag->format();
		        	// dates
                    if (defined('PERCH_LOCALE')) {
                            if( $tag->format()=="%m"){
                              ...
                              $modified_value = IntlDateFormatter::formatObject(
                                                                                new DateTime(($modified_value)), //a DateTime object
                                                                               "MMMM",  //UCI standard formatted string
                                                                               PERCH_LOCALE //the locale
                                                                           );
                            } else if( $tag->format()=="%MMM"){

                              $modified_value = IntlDateFormatter::formatObject(
                                                                                new DateTime(($modified_value)), //a DateTime object
                                                                               "MMM",  //UCI standard formatted string
                                                                               PERCH_LOCALE //the locale
                                                                           );

                            }else if( $tag->format()=="%d"){

                                                               $modified_value = IntlDateFormatter::formatObject(
                                                                                                                 new DateTime(($modified_value)), //a DateTime object
                                                                                                                "dd",  //UCI standard formatted string
                                                                                                                PERCH_LOCALE //the locale
                                                                                                            );
                                                             }else if( $tag->format()=="%Y"){

                                                                                                                             $modified_value = IntlDateFormatter::formatObject(
                                                                                                                                                                               new DateTime(($modified_value)), //a DateTime object
                                                                                                                                                                              "yyyy",  //UCI standard formatted string
                                                                                                                                                                              PERCH_LOCALE //the locale
                                                                                                                                                                          );
                                                                                                                           }else{
                               $modified_value = IntlDateFormatter::formatObject(
