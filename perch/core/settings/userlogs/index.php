<?php
    ...
    if (isset($_GET['extended'])) {
        include(__DIR__ . '/../modes/userlogs.extended.pre.php');
    }else{
        include(__DIR__ . '/../modes/userlogs.pre.php');
    }
    ...
    include(PERCH_CORE . '/inc/top.php');
     ...
     if (isset($_GET['extended'])) {
         include(__DIR__ . '/../modes/userlogs.extended.post.php');
     }else{
         include(__DIR__ . '/../modes/userlogs.post.php');
     }
